...
%      applied to the GUI before BODE_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 23-Apr-2013 09:19:58
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
num1=get(handles.edit5,'String');
r3= str2double(num1);
num2=get(handles.edit6,'String');
c3= str2double(num2);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
num1=get(handles.edit7,'String');
r4= str2double(num1);
num2=get(handles.edit8,'String');
c4= str2double(num2);
